...
public class MyWorker extends Worker {
    ...
    private Result getCurrentWeather(String city){
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=41ea0e0fa6a4e2ac1b5cfcc18a338744";
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    String title = "Weather report of " + city;
                    String message =  "The current condition is " + description + " with " + temperature + "° Celcius";
                    int notifId = 201;
